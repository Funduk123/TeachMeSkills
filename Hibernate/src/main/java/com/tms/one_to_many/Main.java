package com.tms.one_to_many;

import com.tms.one_to_many.domain.Address;
import com.tms.one_to_many.domain.Phone;
import com.tms.one_to_many.domain.UserEntity;
import com.tms.one_to_many.service.UserService;
...
public class Main {
    public static void main(String[] args) {
        ...
        ApplicationContext context = new AnnotationConfigApplicationContext("com.tms.one_to_many");
